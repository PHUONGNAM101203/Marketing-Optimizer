...
const GUIDE_STEPS: Readonly<Record<ProviderFamily, readonly string[]>> = {
  ...
  meta: [
    ...
    'Số liệu riêng của Trang Facebook (lượt hiển thị/tương tác Page, KHÁC Facebook Ads) đang TẠM NGƯNG (8/2026): quyền "read_insights" cần cho việc này bị Facebook từ chối "Invalid Scopes" trên app thật, chưa xác minh được cách xin đúng — đã bỏ khỏi danh sách quyền yêu cầu để không chặn kết nối Instagram/Page cơ bản. "pages_show_list"/"pages_read_engagement" vẫn xin bình thường, đủ để kết nối và đọc Instagram.',
