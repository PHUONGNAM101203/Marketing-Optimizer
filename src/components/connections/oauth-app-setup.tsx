...
const GUIDE_STEPS: Readonly<Record<ProviderFamily, readonly string[]>> = {
  ...
  meta: [
    ...
    'Muốn lấy cả nội dung hữu cơ của chính Trang Facebook (bài đăng, lượt hiển thị, tương tác — KHÁC Facebook Ads) thì vào App Dashboard → Permissions and Features, xin thêm 3 quyền: "pages_show_list", "pages_read_engagement", "read_insights". Cả ba ở mức Standard Access — tài khoản có vai trò trong App (Admin/Developer/Tester) và có vai trò quản trị Trang là đọc được ngay, không cần nộp App Review.',
